#This version prints the proportions of each type and has a better title.  
                ...
                for (i in 1:N){
                        ...
                        while((j<=M-1) && AICdelta[j,i]<=pval){
                                ...
                                if(AICdelta[j,i]<=pval){
                                        ...
                                        output$results1 <- renderText({"Component geometric means:"})
                                        ...
                                        output$results2 <- renderText({"Respective proportions:"})
